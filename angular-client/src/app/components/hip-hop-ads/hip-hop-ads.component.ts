...
@Component({
  selector: 'app-hip-hop-ads',
  templateUrl: './hip-hop-ads.component.html',
  styleUrls: ['./hip-hop-ads.component.css']
})
export class HipHopAdsComponent implements OnInit {
