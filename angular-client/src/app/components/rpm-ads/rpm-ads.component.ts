...
@Component({
  selector: 'app-rpm-ads',
  templateUrl: './rpm-ads.component.html',
  styleUrls: ['./rpm-ads.component.css']
})
export class RpmAdsComponent implements OnInit {
